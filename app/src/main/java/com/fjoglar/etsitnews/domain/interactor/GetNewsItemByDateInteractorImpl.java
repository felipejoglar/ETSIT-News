 ...
 * one coming last.
 */
public class GetNewsItemByDateInteractorImpl extends UseCase implements GetNewsItemByDateInteractor {

    private Callback mCallback;
    private NewsRepository mNewsRepository;
    private long mDate;

    public GetNewsItemByDateInteractorImpl(Executor threadExecutor, MainThread mainThread,
    ...
    public void run() {
        // Get the item.
        final NewsItem newsItem = mNewsRepository.getNewsItemByDate(mDate);
