 ...
 */
package com.fjoglar.etsitnoticias.sync;
...
/**
 * Manages "Authentication" to ETSIT's backend service.  The SyncAdapter framework
 ...
 */
public class EtsitAuthenticator extends AbstractAccountAuthenticator {

    // Simple constructor
    public EtsitAuthenticator(Context context) {
        super(context);
    }
